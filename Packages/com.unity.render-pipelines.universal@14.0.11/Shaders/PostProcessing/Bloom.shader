Shader "Hidden/Universal Render Pipeline/Bloom"
{
    HLSLINCLUDE
        ...
        half4 FragPrefilter(Varyings input) : SV_Target
        {
            ...
            // LQ-only Bloom: removes the 13-tap Karis downsample variant.
        ...
        half4 FragBlurH(Varyings input) : SV_Target
        {
            ...
            // Bilinear 5-tap gaussian approximation of the original 9-tap blur.
            half3 c0 = DecodeHDR(SAMPLE_TEXTURE2D_X(_BlitTexture, sampler_LinearClamp, uv - float2(texelSize * 3.23076923, 0.0)));
            half3 c1 = DecodeHDR(SAMPLE_TEXTURE2D_X(_BlitTexture, sampler_LinearClamp, uv - float2(texelSize * 1.38461538, 0.0)));
            half3 c2 = DecodeHDR(SAMPLE_TEXTURE2D_X(_BlitTexture, sampler_LinearClamp, uv));
            half3 c3 = DecodeHDR(SAMPLE_TEXTURE2D_X(_BlitTexture, sampler_LinearClamp, uv + float2(texelSize * 1.38461538, 0.0)));
            half3 c4 = DecodeHDR(SAMPLE_TEXTURE2D_X(_BlitTexture, sampler_LinearClamp, uv + float2(texelSize * 3.23076923, 0.0)));
