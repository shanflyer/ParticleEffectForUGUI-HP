...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        static void InitializeStackedCameraData(Camera baseCamera, UniversalAdditionalCameraData baseAdditionalCameraData, ref CameraData cameraData)
        {
            ...
            cameraData.renderScaleRT = isScenePreviewOrReflectionCamera ? 1.0f : settings.renderScaleRT;

            bool isPortrait = cameraData.pixelHeight > cameraData.pixelWidth;
            cameraData.widthLimitScene = isPortrait ? settings.widthLimitScene : settings.hightLimitScene;
            cameraData.hightLimitScene = isPortrait ? settings.hightLimitScene : settings.widthLimitScene;
