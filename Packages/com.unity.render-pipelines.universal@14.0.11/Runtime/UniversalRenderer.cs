...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class UniversalRenderer : ScriptableRenderer
    {
        ...
        public UniversalRenderer(UniversalRendererData data) : base(data)
        {
            ...
            if (data.optimizeOpaqueStateChanges)
            {
                var opaqueStateSortFlags = SortingCriteria.SortingLayer | SortingCriteria.RenderQueue | SortingCriteria.OptimizeStateChanges | SortingCriteria.CanvasOrder;
                m_RenderOpaqueForwardPass.customSortFlags = true;
                m_RenderOpaqueForwardPass.sortFlags = opaqueStateSortFlags;
                m_RenderOpaqueForwardWithRenderingLayersPass.customSortFlags = true;
                m_RenderOpaqueForwardWithRenderingLayersPass.sortFlags = opaqueStateSortFlags;
            }
