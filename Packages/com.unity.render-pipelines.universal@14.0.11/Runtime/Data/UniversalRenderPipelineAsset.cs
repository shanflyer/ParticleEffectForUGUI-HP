...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] float m_RenderScaleRT = 1.0f;
        [SerializeField] int m_WidthLimitScene = 1080;
        [SerializeField] int m_HightLimitScene = 1920;
        ...
        /// <summary>
        /// Specifies the render scale applied to cameras that render to a RenderTexture.
        /// </summary>
        public float renderScaleRT
        {
            get { return m_RenderScaleRT; }
            set { m_RenderScaleRT = ValidateRenderScale(value); }
        }

        /// <summary>
        /// Maximum scene render width for cameras that render to the screen.
        /// </summary>
        public int widthLimitScene
        {
            get { return m_WidthLimitScene; }
            set { m_WidthLimitScene = value; }
        }

        /// <summary>
        /// Maximum scene render height for cameras that render to the screen.
        /// </summary>
        public int hightLimitScene
        {
            get { return m_HightLimitScene; }
            set { m_HightLimitScene = value; }
        }
