...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public partial class AdditionalLightsShadowCasterPass : ScriptableRenderPass
    {
        ...
        public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
        {
            ...
            bool resetTargetForPowerVR = Application.platform == RuntimePlatform.Android && PlatformAutoDetect.isRunningOnPowerVRGPU;
            if (resetTargetForPowerVR)
                ResetTarget();

            RTHandle shadowTarget = m_CreateEmptyShadowmap ? m_EmptyAdditionalLightShadowmapTexture : m_AdditionalLightsShadowmapHandle;
            if (resetTargetForPowerVR)
                ConfigureTarget(shadowTarget, shadowTarget);
            else
