...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class DrawObjectsPass : ScriptableRenderPass
    {
        ...
        public bool customSortFlags = false;
        public SortingCriteria sortFlags = SortingCriteria.CommonOpaque;
        ...
        {
            m_PassData.customSortFlags = customSortFlags;
            m_PassData.sortFlags = sortFlags;
        ...
        private static void ExecutePass(ScriptableRenderContext context, PassData data, ref RenderingData renderingData, bool yFlip)
        {
            ...
            using (new ProfilingScope(cmd, data.m_ProfilingSampler))
            {
                ...
                if (data.customSortFlags)
                {
                    sortFlags = data.sortFlags;
                }
                else
                {
                    sortFlags = (data.m_IsOpaque) ? renderingData.cameraData.defaultOpaqueSortFlags : SortingCriteria.CommonTransparent;
                    if (renderingData.cameraData.renderer.useDepthPriming && data.m_IsOpaque && (renderingData.cameraData.renderType == CameraRenderType.Base || renderingData.cameraData.clearDepth))
        ...
        private class PassData
        {
            ...
            internal bool customSortFlags = false;
            internal SortingCriteria sortFlags = SortingCriteria.CommonOpaque;
        }
