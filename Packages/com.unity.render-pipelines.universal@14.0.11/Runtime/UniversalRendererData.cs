...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class UniversalRendererData : ScriptableRendererData, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] bool m_OptimizeOpaqueStateChanges = false;
#if UNITY_EDITOR
        ...
        /// <summary>
        /// Sort opaque objects by render state instead of quantized front-to-back distance.
        /// </summary>
        public bool optimizeOpaqueStateChanges
        {
            get => m_OptimizeOpaqueStateChanges;
            set
            {
                SetDirty();
                m_OptimizeOpaqueStateChanges = value;
            }
        }
