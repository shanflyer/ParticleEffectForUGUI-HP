...
namespace UnityEngine.Rendering.Universal
{
    ...
    public struct CameraData
    {
        ...
        /// <summary>
        /// Returns the scaled width for a camera that renders to a RenderTexture.
        /// </summary>
        public int scaledWidthRT => Mathf.Max(1, (int)(camera.pixelWidth * renderScaleRT));

        /// <summary>
        /// Returns the scaled height for a camera that renders to a RenderTexture.
        /// </summary>
        public int scaledHeightRT => Mathf.Max(1, (int)(camera.pixelHeight * renderScaleRT));
        ...
        public float renderScaleRT;
        public int widthLimitScene;
        public int hightLimitScene;
    ...
    public sealed partial class UniversalRenderPipeline
    {
            ...
            bool isHdrEnabled, HDRColorBufferPrecision requestHDRColorBufferPrecision, int msaaSamples, bool needsAlpha, bool requiresOpaqueTexture)
        {
            ...
            if (camera.targetTexture == null)
            {
                ...
                if (cameraData.widthLimitScene > 0 && cameraData.hightLimitScene > 0)
                {
                    float scale = Mathf.Min(1.0f, Mathf.Min((float)cameraData.widthLimitScene / width, (float)cameraData.hightLimitScene / height));
            ...
            else
            {
                ...
                desc.msaaSamples = msaaSamples;
                desc.width = cameraData.scaledWidthRT;
                desc.height = cameraData.scaledHeightRT;
