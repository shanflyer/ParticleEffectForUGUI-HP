...
namespace UnityEditor.Rendering.Universal
{
    ...
    public class UniversalRendererDataEditor : ScriptableRendererDataEditor
    {
        private static class Styles
        {
            ...
            public static readonly GUIContent OptimizeOpaqueStateChangesLabel = EditorGUIUtility.TrTextContent("Optimize Opaque State Changes", "Sorts opaque objects by render state instead of quantized front-to-back distance. This can reduce opaque batch fragmentation at the cost of some front-to-back overdraw optimization.");
        ...
        SerializedProperty m_OptimizeOpaqueStateChanges;
        ...
        private void OnEnable()
        {
            ...
            m_OptimizeOpaqueStateChanges = serializedObject.FindProperty("m_OptimizeOpaqueStateChanges");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_OptimizeOpaqueStateChanges, Styles.OptimizeOpaqueStateChangesLabel);
