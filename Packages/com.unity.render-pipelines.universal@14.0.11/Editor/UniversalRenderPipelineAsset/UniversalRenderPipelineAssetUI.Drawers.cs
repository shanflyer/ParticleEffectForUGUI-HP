...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal partial class UniversalRenderPipelineAssetUI
    {
        ...
        static void DrawQuality(SerializedUniversalRenderPipelineAsset serialized, Editor ownerEditor)
        {
            ...
            EditorGUILayout.PropertyField(serialized.widthLimitScene, new GUIContent("Scene Width Limit"));
            EditorGUILayout.PropertyField(serialized.hightLimitScene, new GUIContent("Scene Height Limit"));
            serialized.renderScaleRT.floatValue = EditorGUILayout.Slider(new GUIContent("Render Texture Scale"), serialized.renderScaleRT.floatValue, UniversalRenderPipeline.minRenderScale, UniversalRenderPipeline.maxRenderScale);
